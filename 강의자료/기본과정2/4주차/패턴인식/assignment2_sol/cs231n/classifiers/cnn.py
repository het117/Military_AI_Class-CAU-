...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache_3 = affine_forward(y_2, W3, b3)
        ...
        #backpropagation
        dout1,grads['W3'],grads['b3'] = affine_backward(grad_1,cache_3)
        dout2,grads['W2'],grads['b2'] = affine_relu_backward(dout1,cache_2)
        dout3,grads['W1'],grads['b1'] = conv_relu_pool_backward(dout2,cache_1)
